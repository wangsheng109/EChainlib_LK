...
namespace echain {
	...
	public:
		...
		//int CheckCertificate(const echain::P2pConfigure& p2p_configure, char *serial, bool& use_ca, char *out_msg);
		...
		//bool VerifyCertificate(void *x509, const echain::SSLConfigure& ssl_configure, const void *ca_list, char *out_msg);
		bool VerifyCertificate(void *x509, const char *verify_file, const char * chain_file, const void *ca_lists, char *out_msg);

		// get all ca list
		//bool GetCertificatList(const echain::CAServerConfigure& ca_server_configure, const std::string serial_num, void *ca_lists, char *out_msg);
